...
@component function PVCell(; name, Rs=0.221, Rp=415.405, T=300.15, Gn=1000, ipv_n=8.214, Ki=0.0032, a=1.3, Ns=54, Vocn=32.9, Iscn=8.21, Kv=-0.123, k=1.380649e-23, q=1.602176634e-19)
  ...
  append!(__params, @parameters (a::Float64 = a), [description = "parameter ΔT::Real = 23"])
  ...
  append!(__vars, @variables (ipv(t)), [description = "variable G::Real"])
  ...
  push!(__systems, @named V = Example1.VoltageSensor())
  push!(__systems, @named Im = Example1.CurrentSource())

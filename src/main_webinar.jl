# As presented on 7/9/25
# This version uses a combination of models implmented in Dyad and also directly in MTK
...
include("analysis/orbit_analysis.jl")

@mtkmodel TempSensor0 begin
    @parameters begin
...
@mtkmodel PVCellValidation0 begin
    @components begin 
...
@mtkbuild validation_test = PVCellValidation0() # additional_passes=[ModelingToolkit.IfLifting]
...
@mtkmodel SolarPanel0 begin
    @components begin 
        ...
        i = CurrentSensor()
        ground = Ground()
        temp = TempSensor0()     # Determines temperature and irradiance from orbital analysis
    end
    @equations begin 
